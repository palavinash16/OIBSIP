...
Welcome to my official **Oasis Infobyte Internship (OIBSIP)** repository. This repository serves as a centralized hub for all project tasks completed during my internship under the **Data Analytics** track.
...
- **Domain Track**: Data Analytics
- **GitHub Repository**: [`palavinash16/OIBSIP`](https://github.com/palavinash16/OIBSIP)
- **Internship Provider**: Oasis Infobyte (AICTE Recognized)

---

### 📋 Internship Track Matrix & Completion Rules
- **Domain**: Data Analytics (7 Total Available Tasks across Level 1 & Level 2)
- **Minimum Requirement**: Complete at least 3 tasks from Level 1 or Level 2 combined.
- **Target Goal**: Complete maximum tasks across both levels to qualify for a **Letter of Recommendation (LOR)**.
- **Naming Rule**: `OIBSIP/[TrackName]-[Level/Task]-[ProjectName]/`

---

### 📊 Master Task Progress Tracker
